...
namespace ShiryuTeam {
	...
	{
		std::string Name = "ShiryuTeam App";
		uint32_t Width = 1600;
		uint32_t Height = 900;
		...
		// Uses custom ShiryuTeam titlebar instead
		// of Windows default
	...
	private:
		...
		std::shared_ptr<ShiryuTeam::Image> m_AppHeaderIcon;
		std::shared_ptr<ShiryuTeam::Image> m_IconClose;
		std::shared_ptr<ShiryuTeam::Image> m_IconMinimize;
		std::shared_ptr<ShiryuTeam::Image> m_IconMaximize;
		std::shared_ptr<ShiryuTeam::Image> m_IconRestore;
	};
