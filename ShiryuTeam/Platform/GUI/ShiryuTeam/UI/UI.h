...
namespace ShiryuTeam::UI {
	...
	void DrawButtonImage(const std::shared_ptr<ShiryuTeam::Image>& imageNormal, const std::shared_ptr<ShiryuTeam::Image>& imageHovered, const std::shared_ptr<ShiryuTeam::Image>& imagePressed,
	...
	void DrawButtonImage(const std::shared_ptr<ShiryuTeam::Image>& image,
		ImU32 tintNormal, ImU32 tintHovered, ImU32 tintPressed,
		ImVec2 rectMin, ImVec2 rectMax);
